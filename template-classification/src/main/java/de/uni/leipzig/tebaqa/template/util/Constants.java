...
public class Constants {
    ...
    public static final String DEFAULT_SERIALIZED_CLASSIFIER_FILENAME = "question_classification.model";
    public static final String DEFAULT_SERIALIZED_GRAPHS_FILENAME = "graphs.txt";
    public static final String DEFAULT_SERIALIZED_MAPPINGS_FILENAME = "mappings.json";
