 ...
 * Copied from {@link org.aksw.mlqa.analyzer.querytype.QueryResourceTypeAnalyzer} and modified Spotlight URL
 * because the original Spotlight API URL is down.
 */
public class QueryResourceTypeAnalyzer implements IAnalyzer {
    ...
    private org.aksw.qa.commons.nlp.nerd.Spotlight spotter;
    ...
    public QueryResourceTypeAnalyzer() {
        ...
        attributeValues.addElement("DBpedia:Biomolecule");
        ...
        this.spotter = Utilities.createCustomSpotlightInstance("http://model.dbpedia-spotlight.org/en/annotate");
    }
    ...
    public Object analyze(String q) {
        ...
        if (!entities.isEmpty()) {
            for (org.aksw.qa.commons.datastructure.Entity tmpEntity : entities.get("en")) {
