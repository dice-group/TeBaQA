...
//            return single.getObject().equals(compound.getSubject());
//        } else {
//            return single.getSubject().equals(compound.getSubject());
//        }
//    }
//
...
//        return t1.getObject().equals(t2.getSubject()) ||
//                !compound[0].getObject().equals(compound[1].getSubject());
//    }
//
...
////            if (typeVars.size() > 0)
////                varMappings = generateTypeValMappings(varMappings, resourceLinker, typeVars, replacements.size());
////            if (singleVars.size() > 0)
////                varMappings = generateSingleValMappings(varMappings, resourceLinker, singleVars, replacements.size());
////
////
