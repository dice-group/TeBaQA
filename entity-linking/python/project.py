...
candidates = getEntities(entities)

#print("Candidate Generation Done")

# 2. Entity Linking

inputCandidates = testdatam(test_sentence, candidates)
#print("project input Candidates: ", inputCandidates)

entityLabels = createLinks(inputCandidates)
#print("Entity Labels: ", entityLabels)

# Relation Extraction
# 1. Candidate Generation
#relationCandidates = getRelations(test_sentence, entityLabels)
#print("candidates for RE", relationCandidates)
#relationLinks = testdata(test_sentence, relationCandidates)
