...
public class UtilitiesTest {
    ...
    public void resolveNamespacesTest() throws Exception {
        String s = Utilities.resolveNamespaces("PREFIX dbo: <http://dbpedia.org/ontology/>\n" +
    ...
    public void resolveNamespacesTestTwoTriples() throws Exception {
        String s = Utilities.resolveNamespaces("PREFIX dbo: <http://dbpedia.org/ontology/> PREFIX res: <http://dbpedia.org/resource/> SELECT DISTINCT ?uri WHERE { res:Nile dbo:city ?uri . res:Nile dbo:city ?uri . }");
    ...
    public void resolveNamespacesTestWithSmallerChar() throws Exception {
        String s = Utilities.resolveNamespaces("ASK WHERE { " +
                "?class_ ?property_ ?x . " +
                "?class_ ?property_ ?y . " +
                "FILTER (?x < ?y) . " +
